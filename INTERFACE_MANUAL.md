...
* **`MUTATION CHANCE PERCENTAGE`** Hodnota v poli udává, jaká je procentuální šance, že nová buňka u akce *buněčné dělení* zmutuje. Pokud buňka zmutuje, tak má stejnou šanci, že zmutuje znovu a to se opakuje dokud mutuje.
